...
out.println("<form action='findEmpDeptno'>  <button> Find By Employee Department Number</button></form>");
out.println("<form action='findEmpJob'>  <button> Find By Employee Job</button></form> ");
