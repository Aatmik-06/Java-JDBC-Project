...
public class addEmpController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addEmpController</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            int r = ed.addStudent(eb); 
             if (r > 0) {
                 out.println("<h1 style='color: green'>Employee Added Sucessfully</h1>");
                }
            else{
              out.println("<h1><font color='red'>Employee Not Added </font></h1>");
            }
