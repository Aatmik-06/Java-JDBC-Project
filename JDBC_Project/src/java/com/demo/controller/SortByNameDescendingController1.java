 ...
 * @author adi18
 */
public class SortByNameDescendingController1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SortByNameDescendingController1</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            out.print("<h1 align='center'>Sorted Employees By Name In Descending Order</h1");
            ...
            ArrayList<EmpBean> list = ed.sortByNameDesc();
