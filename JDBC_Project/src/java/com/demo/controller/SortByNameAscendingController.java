 ...
 * @author adi18
 */
public class SortByNameAscendingController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SortByNameAscendingController</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            out.print("<h1 align='center'>Sorted Employees By Name In Ascending Order</h1");
            ...
            ArrayList<EmpBean> list = ed.sortByNameAsc();
